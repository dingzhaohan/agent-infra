...
https://deepmodeling.github.io/jax-fem/
...
https://pages.nist.gov/fipy/en/latest/
...
https://www.plumed.org/doc-v2.9/user-doc/html/
...
https://colvars.github.io/colvars-manual/
...
https://torchmd-net.readthedocs.io/
...
GADGET-4 / MP-Gadget
rolling
https://github.com/weiguangcui/Gadget4
...
https://bout-dev.readthedocs.io/en/latest/
...
rolling
https://genecode.org/
https://genecode.org/documentation/
...
https://alexdobin.github.io/STAR/
参考基因组/转录组 index
RNA-seq 比对
生物信息
HISAT2
...
https://www.beast2.org/documentation/
...
参考基因组 + Known sites（dbSNP/1000G/gnomAD 等）
基因富集
生物信息
fgsea
1.x
...
转录因子/基序库（cisTarget/TF motif DB）
单细胞分析
生物信息/单细胞
Scanpy
1.x
...
预训练权重 + 结构/序列数据库（PDB/UniRef/BFD/MGnify等）
结构预测（AF2 开源推理）
结构生物学
AlphaFold2
rolling
https://github.com/google-deepmind/alphafold
https://github.com/google-deepmind/alphafold#documentation
预训练权重 + 结构/序列数据库（PDB/UniRef/BFD/MGnify等）
蛋白设计
结构生物学
ProteinMPNN
...
https://github.com/dauparas/ProteinMPNN#readme
预训练权重
分子对接
结构生物学/药物
AutoDock Vina
